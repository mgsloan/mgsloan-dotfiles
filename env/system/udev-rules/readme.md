...
AC plug and unplug, via `~/env/system/scripts/cpu-governor-apply.sh`. See that
script's header, and `~/env/system/polkit-rules/60-cpu-governor.rules` for why root
